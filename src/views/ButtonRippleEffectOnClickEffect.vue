                        ...
                        <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar u-header__navbar--no-space position-static">
                            ...
                            <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                <ul class="navbar-nav u-header__navbar-nav u-header__navbar-nav-divider flex-wrap">
                                    ...
                                    <!-- Mobiles -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="#">Mobiles & Tablets Accessories</a>
                                    </li>
                                    <!-- End Mobiles -->

                                    <!-- Microsoft Surface Pro 3 -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="#">Microsoft Surface Pro 3</a>
                                    </li>
                                    <!-- End Microsoft Surface Pro 3 -->

                                    <!-- Smart Watches -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="#">Smart Watches</a>
                                    </li>
                                    <!-- End Smart Watches -->

                                    <!-- PlayStation 4 Pro Console -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="#">PlayStation 4 Pro Console</a>
                                    </li>
                                    <!-- End PlayStation 4 Pro Console -->

                                    <!-- Canon EOS 700D -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="#">Canon EOS 700D</a>
                                    </li>
                                    <!-- End Canon EOS 700D -->

                                    <!-- Home Appliances -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="#">Home Appliances</a>
                                    </li>
                                    <!-- End Home Appliances -->

                                    <!-- Samsung Smart TVs -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="#">Samsung Smart TVs</a>
                                    </li>
                                    <!-- End Samsung Smart TVs -->

                                    <!-- Button -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="font-weight-bold nav-link u-header__nav-link" href="#" aria-haspopup="true" aria-expanded="false" target="_blank">
                                            ...More
                                        </a>
                                    </li>
                                    <!-- End Button -->
                            ...
                            <div class="banner-bg">
                                <a href="../shop/shop.html" class="min-height-146 py-3 py-xl-3 py-wd-4 my-2 my-wd-1 d-inline-flex align-items-center text-gray-90">
                                    ...
                                    <div class="col-7 col-md-6 pr-xl-15 pr-wd-19">
                                        ...
                                        <div class="link text-gray-90" href="#">
...
<script>
import HSMegaMenu from "@/assets/vendor/hs-megamenu/src/hs.megamenu.js"
import HSCore from "@/assets/js/hs.core.js"
import HSUnfold from "@/assets/js/components/hs.unfold.js"
import HSShowAnimation from "@/assets/js/components/hs.show-animation.js"
import HSSlickCarousel from "@/assets/js/components/hs.slick-carousel.js"
import HSFancyBox from "@/assets/js/components/hs.fancybox.js"
import HSCountdown from "@/assets/js/components/hs.countdown.js"
import HSGoTo from "@/assets/js/components/hs.go-to.js"
import HSMalihuScrollBar from "@/assets/js/components/hs.malihu-scrollbar.js"
import HSHeader from "@/assets/js/components/hs.header.js"
import HSSVGIngector from "@/assets/js/components/hs.svg-injector.js"
import HSValidation from "@/assets/js/components/hs.validation.js"
import HSHamburgers from "@/assets/js/components/hs.hamburgers.js"
import HSSelectPicker from "@/assets/js/components/hs.selectpicker.js"
import HSOnScrollAnimation from "@/assets/js/components/hs.onscroll-animation.js"
