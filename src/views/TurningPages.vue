<template>
    <div class="home">
        <div class = "title">Turning Pages Example</div>
        <div class="MainBox">
...
@for $i from 2 through 6 {
    @keyframes nextFlip#{$i} {
        @for $j from 0 through 4 {
            ...
            #{((10 + ($j * 20)) + (($i - 1) * 0.5))}% { background-image: nth($images, ($j + 2)); background-position: #{-238 - (($i - 2) * 30)}px; transform: rotateY(180deg); }
        }
    }
}
...
@keyframes nextFlip7 {
    @for $i from 0 through 4 {
        ...
        #{13 + ($i * 20)}% { background-image: nth($images, ($i + 2)); background-position: -388px; transform: rotateY(180deg); }
    }
}
